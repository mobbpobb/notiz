// System: Windows Server 2022 und (neu) Windows 11
...
Server > Tools > Gruppenrichtlinienverwaltung > Gesamtstruktur > Domänen > "firma.local" > "Default Domain Policy" bearbeiten > (Gruppenrichtlinienverwaltungs-Editor) Computerkonfiguration > Richtlinien > Windows Einstellungen > Sicherheitseinstellungen > Kontorichtlinien > Kennwortrichtlinien >  05_Mitarbeiter(Gruppe)
...
Lokale Admin-Gruppe für 01_Geschäftsführer(Gruppe) und 05_IT_Digitalisierung(Gruppe) 
einrichten: (da "Domänen-Admin zu stark ist und BSI-Verstoß?)

GPO > Computer > neues Objekt erstellen > das Objekt Bearbeiten > Computerkonfiguratiion > Einstellungen > Systemsteuerungseinstellungen > Lokale Benutzer und Gruppen > Lokale Gruppe > 
Dropdown-Menü > Administratoren(integriert) > Mitglieder: Hinzufügen > "Gruppen"
...
--> AD: Ansicht > Erweiterte Features > "OU" > Eigenschaften > Objekt > deaktiviert: "Objekt vor zufälligem Löschen schützen" --> Löschen ermöglicht
